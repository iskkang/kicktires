...
if(fs.existsSync(carsFile)){
  ...
  html=html.replace(/<nav>[\s\S]*?<\/nav>/i,`<nav><div class="navin hub-nav"><a class="logo" href="/"><i></i>KickTires</a><div class="navlinks"><a class="navlink" href="/#check">Analyze</a><a class="navlink" href="/cars/">Research</a><a class="navlink" href="/cars/#all-models">All models</a><a class="navlink" href="/about/">About</a><a class="navlink navcheck" href="/#check">Analyze a Car</a></div></div></nav>`);
