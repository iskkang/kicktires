...
const nav = `<nav><div class="navin kt-nav"><a class="logo" href="/"><i></i>${NAME}</a><div class="navlinks"><a class="navlink navcheck" href="/#check">Analyze</a><a class="navlink" href="/cars/">Research</a><a class="navlink" href="/#compare">Compare</a><a class="navlink" href="${bestHref}">Best Years</a><a class="navlink" href="${problemsHref}">Common Problems</a><a class="navlink" href="/about/">About</a><a class="kt-nav-cta" href="/#check">Analyze a Car</a></div></div></nav>`;
...
const footer = `<footer class="kt-footer"><div class="kt-footer-in"><div><a class="logo" href="/"><i></i>${NAME}</a><p>Buyer-side used-car analysis grounded in federal records, ownership-cost inputs and the listing you are actually considering.</p></div><div><h3>Product</h3><a href="/#check">Analyze a Car</a><a href="/cars/">Research Cars</a><a href="#compare">Compare</a><a href="${bestHref}">Best Years</a></div><div><h3>Resources</h3><a href="${problemsHref}">Common Problems</a><a href="${reliabilityHref}">Reliability</a><a href="${costHref}">Ownership Cost</a><a href="/about/">How We Research</a></div><div><h3>Support</h3><a href="/about/">About</a><a href="/privacy/">Privacy &amp; Cookies</a><a href="https://www.nhtsa.gov/recalls" rel="noopener">NHTSA VIN Lookup ↗</a></div><div class="kt-footer-bottom"><span>© ${new Date().getFullYear()} KickTires. Buyer-first used-car intelligence.</span><span>We take no money from dealers, sellers or marketplaces.</span></div></div></footer>`;
